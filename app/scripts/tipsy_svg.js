...
//http://bl.ocks.org/jdonaldson/1193712
/* jshint strict: false */
(function($) {
    ...
    Tipsy.prototype = {
            ...
            if (title && this.enabled) {
                ...
                switch (gravity.charAt(0)) {
                    ...
                    case 'c':
                        //console.log(e);
                        tp = {
                            top: e.clientY + this.options.offset,
                            left: e.clientX - actualWidth / 2
                        };
                        /**
                        var tip_position = [e.clientX + this.options.offset[0], e.clientY + this.options.offset[1]];
                        if (tip_position[0] + pos.width > $(window).width()) {
                            tp = {
                ...
                var t = this;
                var setHovered = function(setHover) {
                    return function() {
                        t.$tip.stop();
                        t.tipHovered = setHover;
                        if (!setHover) {
                ...
                $tip.hover(setHovered(true), setHovered(false));
            }
        },
        ...
        getTitle: function() {
            ...
            if (typeof o.title === 'string') {
                var titleName = o.title === 'title' ? 'original-title' : o.title;
                if ($e.children(titleName).length) {
                    title = $e.children(titleName).html();
                } else {
                    title = $e.attr(titleName);
                }
    ...
    $.fn.tipsy = function(options) {
        ...
        function enter(e) {
            ...
            if (options.delayIn === 0) {
                ...
                tipsy.fixTitle();
                setTimeout(function() {
                    if (tipsy.hoverState === 'in') {tipsy.show(e);}
                }, options.delayIn);
            }
        }
